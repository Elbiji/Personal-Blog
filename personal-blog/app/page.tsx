        ...
        <footer className="pb-10 pt-10">
          <div className="inset-0  mt-4 p-[1.4px] rounded-xl shadow-xl bg-gradient-to-tr from-neutral-300 via-neutral-200 to-neutral-100">
            <div className="p-[4px] flex h-full w-full rounded-[0.65rem] bg-white justify-between items-center">
              <p className="font-Inter text-xs font-bold text-neutral-500 ml-3">
                Socials 
              </p>
              <div className="flex items-center justify-start">
                <div className="flex gap-1 justify-between">
                  <div className="border-solid border-2 p-[8px] rounded-lg hover:shadow-xl transition-all duration-500 cursor-pointer shadow-sm group">
                    <a href="https://github.com/Elbiji" className="hover:text-emerald-700 duration-300">
                      <svg className="duration-300  fill-neutral-400 group-hover:fill-neutral-500" width="16" height="16"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
