          ...
          <div className="inset-0  mt-4 p-[1.4px] rounded-xl shadow-xl bg-gradient-to-tr from-neutral-300 via-neutral-200 to-neutral-100">
            <div className="p-[4px] flex h-full w-full rounded-[0.65rem] bg-white justify-between items-center">
              <div className="flex items-center gap-1">
                  <div className="group border-solid border-2 p-[8px] rounded-lg hover:shadow-xl transition-all duration-500 cursor-pointer shadow-sm group  bg-gradient-to-br from-white via-white to-neutral-100">
                    <a href="https://github.com/Elbiji" className="hover:text-emerald-700 duration-[3000]">
                ...
                <p className="font-Inter text-xs font-bold text-neutral-500">
                  Socials 
                </p>
              </div>
